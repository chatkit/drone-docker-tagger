...
type (
	...
	Build struct {
		...
		SourceImage string   // Docker image to create tags from
	}
...
func commandTag(build Build, tag string) *exec.Cmd {
	var (
		...
		target = fmt.Sprintf("%s:%s", build.SourceImageNoTag(), tag)
	)
	return exec.Command(
...
// commandPull is a helper function to create the docker pull command.
func commandPull(build Build) *exec.Cmd {
	return exec.Command(dockerExe, "pull", build.SourceImage)
}

// commandPush is a helper function to create the docker push command.
